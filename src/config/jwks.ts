...
type Keys = { private: JWK; public: JWK; allPublic: JWKS };
...
export class JwtService {
  ...
  constructor() {
    const privSet = readJsonEnvOrFile('JWT_JWKS_PRIVATE_JSON', 'JWT_JWKS_PRIVATE_PATH') as JWKS;
    const pubSet  = readJsonEnvOrFile('JWT_JWKS_PUBLIC_JSON',  'JWT_JWKS_PUBLIC_PATH')  as JWKS;
